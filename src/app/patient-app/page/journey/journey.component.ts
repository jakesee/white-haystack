...
export class JourneyComponent implements OnInit {
  ...
  private _cancel(event: FormEvent) {
    ...
    let providerId = this.provider.parentId == -1 ? this.provider.id : this.provider.parentId;
    this._router.navigate(['/patient/provider/', providerId], { relativeTo: this._route });
  }
